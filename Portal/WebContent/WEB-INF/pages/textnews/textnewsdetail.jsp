					...
					<div class="mainList" id="lH">
						<div class="breadCutNav">
							<b class="icon_home"></b> <span>当前位置：</span> <a
								...
								&gt;</span>
							<c:if test="${programTypeName ne null}">
								<a
									href="${pageContext.request.contextPath}/articleList/${programType}_1.html">${programTypeName}</a>
							</c:if>
							<c:if test="${programTypeName eq null}">
								<a
									href="${pageContext.request.contextPath}/leader.do?action=getLeaderList">主任网页</a>
								<span> &gt;</span>
								<a href="javascript:;" class="cur">近期活动</a>
							</c:if>
						</div>
