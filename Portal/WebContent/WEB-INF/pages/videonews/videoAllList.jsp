				...
				<div class="clearfix">
					...
					<div class="mainList" id="lH" style="width:100%">
						<div class="breadCutNav">
							...
							<span> &gt;</span> <a href="javascript:;" class="cur">视频集锦</a>
						...
						<div id="news" >
							<ul class="photoList_sub">
								<c:forEach items="${collectionList }" var="p" varStatus="status">
									<li title="${p.videoNewsName}" >
										<b class="i_video"></b><span style="float:right">${p.entryDate}</span><a  style="width:864px;overflow:hidden;white-space:nowrap;"
							...
							<ut:PortalPager
								url="${pageContext.request.contextPath}/vedioMoreList/${programType}"
