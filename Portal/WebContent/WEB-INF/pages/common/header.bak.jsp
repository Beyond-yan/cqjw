...
<div class="header clearfix">
	...
	<div class="clearfix" style="height:145px;">
		...
		<div style="float: right;">
			<embed src="${pageContext.request.contextPath}/images/jiaowei.swf"
...
<!-- 	<ul class="topNav" style="width: 1400px;margin-left: -140px;" > -->
		<li>
			<a href="http://cx.cqjt.gov.cn/main.html" class="i_menu first " target="_blank">
		...
		<li>
			...
			<div class="subMenu">
				...
				<a href="http://bs.cqjt.gov.cn:8000/cqnet/page/web/homePage.jsp?type=2" target="_blank">办事指引</a>
			</div>
		</li>
		<li class="cur">
...
<!-- 				<a href="http://tw.cqjt.gov.cn:8082" target="_blank">交通图文</a> <br>  -->
		...
		<li>
			...
			<div class="subMenu mr_0">
				...
				<a href="http://zizhan.mot.gov.cn/st2010/chongqing/" target="_blank">交通部子站</a> <br>
				<a href="http://www.cq.gov.cn/" target="_blank" >重庆市政府</a>  
				<a href="http://www.cq.gov.cn/publicinfo/web/views/Show!index.action?orgSid=101" target="_blank" >交委信息公开</a>
			</div>
		</li>
	</ul>
	<!--topNav End-->
...
<img id="floatImg" style="position:fixed;z-index:78;top:253px;left:150px;cursor:hand;" onclick="closeImgDiv();" src="${pageContext.request.contextPath}/images/delete.png"></img>
<div id="floatDiv" style="cursor:pointer; position:fixed;z-index:77;top:260px;left:5px;height:120px;width:150px;border:1px solid #0473b3;padding:2px;">
