...
<script type="text/javascript">
	...
	function setTextNews1HTML(textNews1) {
		...
		for (var i = 0; i < textNews1.length; i++) {
			newHTML += "<li style='float:left;width: 80%;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;' ><a target='_blank' href='${pageContext.request.contextPath}/hyzt2018.do?action=detail&programType=011106&newsID="
					...
					+ "</a></li><span style='float:right;font-family:Microsoft YaHei;font-size: 14px'>"
	...
	function setTextNews5HTML(textNews5) {
		var newHTML = "";
			...
			newHTML += "<div class='news-detail-content'><a target='_blank' style='height:137px;color: rgb(51,51,51);text-decoration:none;display:block;overflow:hidden;'"
...
<body>
	...
	<div class="head"><img src="${pageContext.request.contextPath}/images/trafficconference/head_01.png"/>
    <div class="title">
            <div class="t_cont">
                <ul>
