...
jQuery.fn.gallery = function(config) {
    ...
    var no_click;
    var positions = {
        current: {zIndex: 100, top: "1px",  left: "190px" },
        left: {zIndex: 50, top: "40px", left: "0" },
        right: {zIndex: 25,  top: "40px", left: "543px" },
		none: {zIndex: 0,  top: "40px", left: "200px" }
    };
    var currentD = {width:"640px",height:"323px" };
    var backD = { width:"481px", height:"243px" };
