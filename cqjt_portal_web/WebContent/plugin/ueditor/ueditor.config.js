...
(function () {
     ...
     * 
     */
	if (!window.APP_HOME_URL || window.APP_HOME_URL=="/") window.APP_HOME_URL="";
	window.UEDITOR_HOME_URL = window.APP_HOME_URL + "/plugin/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        //config by Cube @130822
        ,imagePath : window.APP_HOME_URL + "/"            //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
       ...
       //config by Cube @130822
        ...
        //config by Cube @130822
        ,catcherPath : window.APP_HOME_URL + "/"           
        //,catchFieldName:"upfile"                  //提交到后台远程图片uri合集，若此处修改，需要在后台对应文件修改对应参数
        //,separater:'ue_separate_ue'               //提交至后台的远程图片地址字符串分隔符
        ,localDomain:["127.0.0.1","localhost"]      //本地顶级域名，当开启远程图片抓取时，除此之外的所有其它域名下的图片都将被抓取到本地,默认不抓取127.0.0.1和localhost

        //图片在线管理配置区
        ,imageManagerUrl:URL+"jsp/imageManager.jsp"       //图片在线管理的处理地址
        //,imageManagerPath:URL + "jsp/"                                    //图片修正地址，同imagePath
        //config by Cube @130822
        ,imageManagerPath : window.APP_HOME_URL + "/" 
        ...
        , toolbars:[
            ['fullscreen', 
             ...
             'undo', 'redo', 'removeformat', 'formatmatch', 'blockquote', 'pasteplain', 
             '|', 'link', 'unlink', 
             '|', 'insertorderedlist', 'insertunorderedlist', 
             '|', 'horizontal', 'pagebreak', 
             '|', 'snapscreen', 'insertimage', 'insertvideo', 'music', 'attachment', 
             '|', 'date', 'time', 'spechars', 
             '|', 'rowspacingtop', 'rowspacingbottom', 'lineheight', 
             '|', 'imagenone', 'imageleft', 'imageright', 'imagecenter', 
             '|', 'source', 'cleardoc', 'preview', 'help']
        ]
