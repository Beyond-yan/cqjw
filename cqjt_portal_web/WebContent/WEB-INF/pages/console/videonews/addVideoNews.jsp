        ...
        <div class="con docEdit" >
            ...
            <ul>
                <li>
	                ...
	                <input type="text" name="videoTitle" class="input input-medium">
                </li>
                
                <li>
                    <label><span style="color:red">*</span>作者：</label>
                    <input type="text" name="entryUser" class="input input-small" value="${userName}">                   
                ...
                <li>
                    ...
                    <select class="select-small" style="margin:4px" disabled="disabled" name="entryDeptName">
               ...
               <li>
                ...
                <li>
               		<label></label>
                    <a href="javascript:;" class="btn-gray" onclick="saveVideoNews(1)"><b class="icon i-send"></b>发布</a>
...
function saveVideoNews(flag) {
	...
	var options = {
		...
		success : function(data) {			
			...
			asyncbox.confirm(content.msg + "是否继续发布视频？", "确认窗口", function(action) {
				if (action == "ok") {
					document.location.href = "videoNews.xhtml?face=addVideoNewsView";
				}
				else {
