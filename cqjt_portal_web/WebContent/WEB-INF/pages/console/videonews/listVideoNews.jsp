        	...
        	<table width="100%" border="1" class="dataList">
                ...
                <c:forEach items="${paginations}" var="tn" varStatus="status">
					<tr>
                        ...
                        <td>${tn.createDate}</td>
                       <td> <c:if test='${tn.flag==4}'>已修改</c:if>
...
function selectList() {
	...
	location.href ="videoNews.xhtml?face=searchFileList&videoTitle="+videoTitle+"&entryUser="+entryUser+"&entryDateS="
...
function editVideo(videoId){
	location.href ="videoNews.xhtml?face=editVideo&videoId="+videoId;
}
