...
<div>
    ...
    <!--column01 Start-->
     <div class="column" >
        <div class="title"><h2><b class="icon i-search"></b>视频信息审核</h2></div>
        <div class="con docEdit" >
			...
			<input type="hidden" name="path1" value="${video.videoUrl}"/>
			<input type="hidden" id="isPublic" value="${video.isPublic}"/>
            <ul>
                <li>
                ...
                <li>
                     ...
                     <input type="text"  name="verifyDate" value="${verifyDate}" pattern="yyyy-MM-dd " class="input input-small">
                   </div>
                </li>
                <li>
                    <label>来源出处：</label>
              ...
              <li>
                ...
                <li>
                    ...
                    <input type="radio" name="isPublic" id="unPublic" value="0" checked="checked" ><span>否</span>
                </li>
                ...
                <li>
               		<label></label>
                    <a href="javascript:;" class="btn-gray" onclick="saveVideoNews(2)"><b class="icon i-send"></b>审核发表</a>
                   <!--  <a href="javascript:;" class="btn-gray" onclick="saveVideoNews(0)"><b class="icon i-save"></b>存草稿</a> -->
                    ...
                    <!-- <a href="videoNews.xhtml?face=listView" class="btn-gray"><b class="icon i-back"></b>返 回</a> -->
                </li>
            </ul>
            </form>
        </div>
...
function saveVideoNews(flag) {
	...
	var options = {
		...
		success : function(data) {			
			...
			asyncbox.confirm(content.msg+ "是否返回？", "确认窗口", function(action) {
				if (action == "ok") {
					document.location.href = "videoNews.xhtml?face=getVerifyVideolistView";
				}
			}); 
		},
		error :function(data){
