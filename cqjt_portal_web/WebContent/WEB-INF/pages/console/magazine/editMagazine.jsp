...
<div>
    ...
    <!--column01 Start-->
    <div class="column" >
        <div class="title"><h2><b class="icon i-search"></b>杂志刊物信息编辑</h2></div>
        <div class="con docEdit" >
            ...
            <ul>
                <li>
	                ...
	                <input type="text" name="title" class="input input-medium" value="${magazine.title}">
                </li>
                    <li>
                ...
                <li>
               		<label></label>
                    <a href="javascript:;" class="btn-gray" onclick="savemagazineNews(1)"><b class="icon i-send"></b>重新发布</a>
