...
<div>
    ...
    <!--column01 Start-->
    <div class="column" >
        <div class="title"><h2><b class="icon i-search"></b>杂志刊物信息审核</h2></div>
        <div class="con docEdit" >
            ...
            <ul>
                <li>
	                ...
	                <input type="text" name="title" class="input input-medium" value="${magazine.title}" readOnly="true">
                </li>
                    <li>
                    <label><span style="color:red">*</span>投稿人：</label>
                    <input type="text" name="entryUser" class="input input-small" value="${magazine.entryUser}" readOnly="true"> 
                    </li>
                    <li>                  
	                <label><span style="color:red">*</span>录入时间：</label>
                    <input type="text" name="entryDate" class="input input-small" value="${magazine.entryDate}" readOnly="true" >
                    </li>
                    <li>
                    <label><span style="color:red">*</span>杂志期数：</label>
                    <input type="text" name="magazineNo" class="input input-small" value="${magazine.magazineNo}" readOnly="true">
                    </li>
                    <li>  
                      <label><span style="color:red">*</span>上传文件：</label>
                      <input type="file" name="magazineFile">
                      <label>文件链接：</label><a href="${StaticResourcePath}/${magazine.magazineUrl}">${magazine.magazineUrl}</a>
                      <input type="hidden" name="magazine" value="${magazine.magazineUrl}"/>
                ...
                <li id="showPhotoState" >
                	...
                	<label>图片链接：</label><a href="${StaticResourcePath}/${magazine.photoUrl}" target="_blank">${magazine.photoUrl}</a>
                	<input type="hidden" name="photo" value="${magazine.photoUrl}"/>
                ...
                <li>
               		<label></label>
                    <a href="javascript:;" class="btn-gray" onclick="savemagazineNews(2)"><b class="icon i-send"></b>审核</a>
...
function savemagazineNews(flag) {
	...
	var options = {
		...
		success : function(data) {			
			...
			asyncbox.confirm(content.msg + "是否返回杂志刊物信息查询页面？", "确认窗口", function(action) {
				if (action == "ok") {
