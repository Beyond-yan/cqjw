                ...
                <form id="govNewsForm" enctype="multipart/form-data" method="POST">
					<ul>
                        ...
                        <li>
                            ...
                            <label>采用类别：</label>                                                                            
                            <input type="hidden" id="adoptTypeChecked" value="${govNewsInfo.adoptType}">
                        ...
                        <input type="checkbox" class="pubType" name="pubType" value="oneInfo" onclick="choosePubType(this)"><span>一句话信息</span>
                        <input type="checkbox" class="pubType" name="pubType" value="netInfo" onclick="choosePubType(this)"><span>网络信息</span>
