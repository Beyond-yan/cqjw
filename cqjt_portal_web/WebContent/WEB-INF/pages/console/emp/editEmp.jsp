...
<div>
    ...
    <div class="column" >
        ...
        <div class="con docEdit" >
			...
			<input type="hidden" name="empId" value="${EmpShow.empId}">
			<input type="hidden" name="flag" id="newsFlag" />
			<input type="hidden" name="deptName" id="deptName" />
			<input type="hidden" name="categoryName" id="categoryName" />
			<input type="hidden" value="${EmpShow.categoryName}" id="catn" /> 
            <ul>
                <li>
	                <label><span style="color:red">*</span>员工名称：</label>
	                <input type="text" name="empName" class="input input-medium" value="${EmpShow.empName}">
                </li>
                <li>
	                <label><span style="color:red">*</span>员工职位：</label>
	                <input type="text" name="empPost" class="input input-medium" value="${EmpShow.empPost}">
                </li>
                <li>
                    <label><span style="color:red">*</span>录入人：</label>
                    <input type="text" name="entryUser" class="input input-small inputs" value="${EmpShow.entryUser}" readOnly="true">                   
	                <label><span style="color:red"></span>录入时间：</label>
                    <input type="text" name="entryDate" class="input input-small inputs" value="${EmpShow.entryDate}" readOnly="true" >
                </li>  
                <li>
 						<label >部门名称：</label> <select
							id="selectDeptName" name="deptID" class="input input-small inputs">
						</select>
											<label><span style="color:red">*</span>员工排序：</label>
	                <input type="text" style="width:50px;" maxlength="3" id="empSort" name="empSort" class="input input-medium" value="${EmpShow.empSort}">
                </li>
                <li>
              
                	<label><span style="color:red">*</span>员工照片：</label>
                	<input type="file" name="picFile"  onchange="Javascript:validate_img(this);" />
                	<input type="hidden" name="photo" value="${EmpShow.empUrl}"/>
