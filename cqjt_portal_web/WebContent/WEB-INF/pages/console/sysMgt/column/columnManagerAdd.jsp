...
<!--path Start-->
    ...
    <!--path End-->
     <div class="column" id="search">
        <div class="title"><h2><b class="icon i-search"></b>栏目新增</h2></div>
         <div class="con">
		...
		<div class="docEdit" >
			<ul>
			 <li>
                    ...
                    <input type="text" name="createBy" class="input input-small" value="${createBy}" readonly="true" >
                </li>
    			<li>
                    <label><span style="color:red">*</span>栏目名称：</label>
                    <input type="text" name="categoryName"  class="input input-small" style="margin: 3px;width:481px;">
	...
	var options = {
		...
		success : function(data) {
			...
			asyncbox.confirm(content.msg + "是否继续增加？", "确认窗口", function(action) {
				if (action == "ok") {
					document.location.href="column.xhtml?face=addColumn";
				}else{
