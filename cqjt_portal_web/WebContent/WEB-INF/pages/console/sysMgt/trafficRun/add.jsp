...
<!--path Start-->
    ...
    <!--path End-->
     <div class="column" id="search">
        <div class="title"><h2><b class="icon i-search"></b>交通运行信息新增</h2></div>
         <div class="con">
		...
		<div class="docEdit" >
			<ul>
    			<li>
                    ...
                    <input type="text" name="runnTitle" value="" class="input input-small" style="margin: 3px;width:600px;">
				...
				<li class="infoCon clearfix">
					<label></label>
					<div class="btn">
						<a  href="javascript:;"   onclick="insertRunnVo();return false;" class="btn-gray"><b class="icon i-save"></b>保存</a>
...
function insertRunnVo() {
	...
	var options = {
		url : 'trafficRun.xhtml?action=insert',
		type : 'post',
		dataType : "html",
