...
<!--path Start-->
    <div class="path">
        ...
        <span>当前位置：</span>
        <a href="download.xhtml?face=getFileList">资料管理</a>
        <span>-></span>
      	  资料编辑
    </div>
    <!--path End-->
			...
			<ul>
			 <li>
				...
				<li>
					...
					<textarea  name="fileDesc"  class="input input-small" style="margin: 3px; padding: 3px;width:600px; height:100px">${file.fileDesc}</textarea>
				</li>
                 <li style="margin: 3px;">
                	<label>是否置顶：</label>
