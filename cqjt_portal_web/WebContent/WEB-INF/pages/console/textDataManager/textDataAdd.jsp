...
<div>
    ...
    <!--column01 Start-->
    <div class="column" >
        <div class="title"><h2><b class="icon i-search"></b>文字类信息新增</h2></div>
        <div class="con docEdit" >
            ...
            <ul>
                <li>
	                ...
	                <input type="text" name="title" class="input input-large">
                </li>
                <li>
	                <label>版面位置：</label>
	                <input type="radio" name="position" id="public2" value="2" checked="checked"><span>普通新闻</span>&nbsp;&nbsp;
                ...
                <li>
                    <label>作者：</label>
                    <input type="text" name="author"  value="${userName}" class="input input-small" >
                    <label><span style="color:red">*</span>投稿部门：</label>
	                <input type="text" name="entryDept" class="input input-small" value="${userDeptName}">
                
                <li>
                    <label>文档来源：</label>
                    <!-- <input type="text" name="textSource" class="input input-small"> -->
...
function saveTextData(flag) {
	...
	var options = {
		...
		success : function(data) {			
			...
			asyncbox.confirm(content.msg + "点击“取消”,继续录入信息,点击“确定”,将返回到查询页面！", "确认窗口", function(action) {
				if (action == "ok") {
