        	...
        	<div class="column" id="userLogin">
                ...
                <div class="con">
                	<ul class="infoList">
                    	...
                    	<li>
                            <a href="news.xhtml?face=pubNoticenewsDetail&newsId=${n.newsId}"><b class="i-rArr"></b>${n.newsTitle}</a>
                        </li>
                    	</c:forEach>
                    </ul>
                </div>
