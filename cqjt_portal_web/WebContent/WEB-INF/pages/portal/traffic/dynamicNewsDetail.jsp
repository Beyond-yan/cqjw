    ...
    <div class="content clearfix" >
    	...
    	<div class="search-box">
            <div class="breadCutNav">
                ...
                <span> &gt;</span>
                <a href="javascript:;" id="titleTag1">交通信息</a>
            </div>
        ...
        <div class="sub l">
        	<div class="column" id="userLogin">
            	<div class="title">
                	<h2 id="titleTag2">动态信息</h2>
                </div>
                <div class="con">
                	<ul class="infoList">
                		<c:forEach items="${textNewsList}" var="n">
                    	<li>
                            <a href="../guest/news.xhtml?face=dynamicNewsDetail&newsId=${n.newsId}&flagType=${flagType}"><b class="i-rArr"></b>${n.newsTitle}</a>
                        </li>
                    	</c:forEach>
                    </ul>
                </div>
