			...
			<div class="sub l">
				<div class="column">
					...
					<div class="kind" style="text-align: left; margin-left: 230px;">
						...
						<span>&nbsp;&nbsp;&nbsp;</span>
						<a onclick="querySearch(8);return false;" style="color: blue;" id="dept8">企业信用</a>
					...
					<table border="0" align="center"margin-top:"100px">
						...
						<tr id="redBlackQ" style="display: none;">
							...
							<td>
								<input type="text" name="name" value="${name}" id="name" placeholder="企业(人员)名称"
...
function createHtmlNew() {
// function createHtmlNew(data) {
	alert(1);
	var titleTr = '<th>编号</th><th>类型</th><th>名称</th><th>管理</th>';
	$('#titleTr').empty().append(titleTr);
	
	var tbodyFile = '<tr><td>1</td><td>红名单</td><td>重庆旺山</td><td align="center" ><button type="button" onclick="loadData();" >查看详情</button></td></tr>';
