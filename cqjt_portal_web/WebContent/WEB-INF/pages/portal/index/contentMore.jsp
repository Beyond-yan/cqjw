    ...
    <div class="content clearfix">
    	...
    	<div class="search-box">
            <div class="breadCutNav">
                ...
                <span> &gt;</span>
                <a href="javascript:;">${paginations[0].categoryName}</a>
            </div>  
        ...
        <div class="main">
        	<div class="column">
                <div class="title"><h2>${paginations[0].categoryName}</h2></div>
                <input id="deptName" type="hidden" value="${paginations[0].deptName}" />
                <input id="catId" type="hidden" value="${paginations[0].category}" />
                <div class="con">
                	
                    <ul class="infoList  clearfix" id="tbody">
						<c:forEach items="${paginations}" var="pub">
	                    	<li>
	                            <a href="../guest/SearchContent.xhtml?face=queryTextNewsByID&newsId=${pub.newsId}" target="_blank"><b class="i-rArr"></b>${pub.newsTitle}</a>
...
function searchList() {
	...
	$.ajax({
		url : "SearchContent.xhtml?action=getContentMoreView",
		cache : false,
		type : "post",
		dataType : "text",
		data : {
		...
		success : function(data) {
			...
			var createDate="";
			    $.each(json, function(i, n) {
			    	...
			    	publicList+= "<li> <a href='../guest/SearchContent.xhtml?face=queryTextNewsByID&newsId="+n.newsId+"'><b class='i-rArr'></b>"+n.newsTitle+"</a><span class='time'>"+
	    			createDate+"</span></li>"  
			    });
			  $("#tbody").html("");
