...
public class UpdateInnerTrafficIndexJob {
	...
	public void updateTrafficIndexJob() {
		log.debug("solrUrl的值："+solrUrl);
		//全量索引
		String url = solrUrl
				+ "JW_INNER_TRAFFIC/dataimport?command=full-import&entity=inner-traffic-search"
		...
		/*String url = solrUrl
				+ "JW_INNER_TRAFFIC/dataimport?command=delta-import&entity=inner-traffic-search"
				+ "&commit=true&optimize=true&wt=xml&indent=true&verbose=false"
				+ "&clean=false&debug=false";*/
