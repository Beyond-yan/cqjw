...
public class UpdatePublicArchivesIndexJob {
	...
	public void updateArchivesIndexJob() {
		log.debug("solrUrl的值："+solrUrl);
		//全量索引
		String url = solrUrl
				+ "JW_PUBLIC_ARCHIVES/dataimport?command=full-import&entity=public-archives-search"
		...
		/*String url = solrUrl
				+ "JW_PUBLIC_ARCHIVES/dataimport?command=delta-import&entity=public-archives-search"
				+ "&commit=true&optimize=true&wt=xml&indent=true&verbose=false"
				+ "&clean=false&debug=false";*/
