 ...
 * @return
 */
@Service("fileWeatherDao")
public class FileWeatherDao {
	@Autowired
	...
	public List<FileDownload> getAllFile(String fileName,Date startDate,Date endDate,String isDel, int pageIndex, int pageSize,String fileType){
		...
		return (List<FileDownload>) sqlMapClientTemplate
				.queryForList("FileWeather.getFileAll", map, pageIndex, pageSize);
	...
	public FileDownload getFileByFileId(String fileId){
		return  (FileDownload) this.sqlMapClientTemplate.queryForObject("FileWeather.getFileByFileId",fileId);
	}
	...
	public void updateFile(FileDownload fileDownload){
		...
		this.sqlMapClientTemplate.update("FileWeather.updateFile", fileDownload);
	}
	...
	public void deleteFile(Long fileId){
		this.sqlMapClientTemplate.update("FileWeather.deleteFile", fileId);
	}*/
	...
	public void insertFile(FileDownload fileDownload) {
		this.sqlMapClientTemplate.insert("FileWeather.addFile",fileDownload);
	}
	/**
	 * 查询后10条记录资料   
	 */
	...
	public List<FileDownload> getFile(String fileName,Date startDate,Date endDate,String isDel, int pageIndex, int pageSize,String fileType){
		...
		return (List<FileDownload>) sqlMapClientTemplate
				.queryForList("FileWeather.getFile", map, pageIndex, pageSize);
